            ...
            <Card>
                <CardContent>
                        ...
                        <Box display="flex" gap={2}>
                            ...
                            {!isDriver && (
                                <>
                                    ...
                                    <Link href={`/app/%5Blocale%5D/partrides/edit?id=${partRide.id}`} passHref>
                    ...
                    <Typography variant="body1" gutterBottom>
                        ...
                        {partRide.company ? (
                            <Link href={`/app/%5Blocale%5D/companies/${partRide.company.id}`} passHref>
                    ...
                    <Typography variant="body1" gutterBottom>
                        ...
                        {partRide.charter ? (
                            <Link href={`/app/%5Blocale%5D/charters/${partRide.charter.id}`} passHref>
                                <Button variant="text" size="small">
                    ...
                    <Typography variant="body1" gutterBottom>
                        <strong>Ride:</strong>{' '}
                        {partRide.ride ? (
                            <Link href={`/app/%5Blocale%5D/rides/${partRide.ride.id}`} passHref>
                                <Button variant="text" size="small">
                                    {partRide.ride.name}
                                </Button>
                            </Link>
